    ...
    render() {
        return (React.createElement(ScrollView, { style: { backgroundColor: '#EFEFF4' } },
            React.createElement(View, { style: { backgroundColor: '#EFEFF4' } },
                React.createElement(Text, { style: styles.headings }, "Pick your Policies")),
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(EditPolicies));
//# sourceMappingURL=EditPolicies.js.map